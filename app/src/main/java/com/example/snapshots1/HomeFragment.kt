package com.example.snapshots1
...
import com.example.snapshots1.databinding.FragmentHomeBinding
import com.example.snapshots1.databinding.ItemSnapshotBinding
...
class HomeFragment : Fragment(), HomeAux {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mFirebaseAdapter = object  : FirebaseRecyclerAdapter<Snapshot, SnapshotHolder>(options){
            ...
            @SuppressLint("NotifyDataSetChanged")//error interno firebase ui version 8.0.0
